...
- **FR-003** Import SHALL support customers, accounts, ownership relationships,
  history, and required reference data in dependency order.
...
- **FR-007** Referential and financial integrity failures SHALL not leave a
  partially trusted dataset; batch/transaction boundaries SHALL be documented.
...
- Integration tests apply migrations to real SQL Server, import a representative
  dataset twice, and prove idempotency, FK integrity, precision, and rollback.
