...
- [ ] T006 Implement explicit statement API resources and audit events.
- [ ] T007 Add Vitest tests and implement statement request/view/print UI,
  operator bulk outcomes, failed-account retry, and successful-snapshot state.
- [ ] T008 Add tagged Playwright populated, empty, operator bulk partial-failure,
