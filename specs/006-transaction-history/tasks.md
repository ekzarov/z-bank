...
- [x] T001 Add unit tests for versioned cursor validation, binding to account,
...
- [x] T002 Add categorized SQL Server tests for ordering, stable pagination,
  filters, empty history, ownership, and immutable records.
- [x] T003 Add API tests for list/detail authorization and Problem Details.
- [x] T004 Implement history queries and keyset pagination.
- [x] T005 Implement supported account-history and transaction-detail endpoints.
