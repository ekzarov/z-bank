...
and expose provenance without creating CICS/IMS-specific routes.
...
Unit-test cursor validation and mapping. Categorized SQL Server tests verify
query ordering and pagination at equal timestamps. API tests verify security and
errors. Vitest and tagged Playwright cover browsing, details, and empty history.
