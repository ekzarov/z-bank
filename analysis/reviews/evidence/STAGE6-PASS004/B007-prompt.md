...
DECLARED SCOPE — SLICE 007 monthly-statements
- Workbook sheet User Flows rows (Excel row numbers): 100, 101, 102, 103, 104, 105, 106, 107
- SDD artifacts: specs/007-monthly-statements/spec.md, plan.md, tasks.md
